        ...
        <>
            <form onsumit={handleSubmit}>
                <fieldset>
                    ...
                    <label>
                        <input type="text" placeholder="이름" onChange={(event)=>{
                            return setName(event.target.value); }} />
                    </label>
                    <label>
                        <input type="text" placeholder="종" onChange={(event)=>{
                            return setSpecies(event.target.value); }} />
                    </label>
                    <label>
                        <input type="text" placeholder="나이" onChanhe={(event)=>{
...
function Pet(props) { //props안에 데이터가 저장
    return (
